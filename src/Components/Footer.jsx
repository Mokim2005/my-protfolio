...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full backdrop-blur-md border-t border-gray-800 py-12 mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center md:justify-start gap-6">
              ...
              >
                <svg className="w-6 h-6 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.222 17.75h1.92L5.493 5.25H3.446l13.576 14.75z"/>
                </svg>
              </a>
